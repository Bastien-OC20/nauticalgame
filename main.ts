...
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`tile2`, function (sprite, location) {
...
function start_next_level () {
    ...
    tiles.coverAllTiles(assets.tile`tile2`, assets.tile`tile3`)
}
    ...
    if (option == "Play") {
        ...
        timer.after(2000, function () {
            ...
            for (let index2 = 0; index2 < 6; index2++) {
                tiles.setTileAt(tiles.getTileLocation(randint(0, 59), 7), assets.tile`tile2`)
            }
